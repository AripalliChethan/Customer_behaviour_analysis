...
-- Q3 which top 5 products have highest average review rating ?
select item_purchased, round((review_rating),2) as "Average product rating"
from customer 
...
select shipping_type,round(Avg(purchase_amount),2) as avgpurchase_amount
from customer
where shipping_type in ('standard','express')
group by shipping_type;

-- Q5 do subscribed customers spend more? compare avg spent and total revenue between 
